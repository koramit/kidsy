...
<div class="col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        <select class="form-control" name="ward_id">
            ...
            <option {{ isInputChecked($case->ward_id,27,'s') }} value='27'>ฉก15</option>
            ...
            <option {{ isInputChecked($case->ward_id,32,'s') }} value='32'>ปกส3</option>
            <option {{ isInputChecked($case->ward_id,33,'s') }} value='33'>ปาวา2</option>
            <option {{ isInputChecked($case->ward_id,34,'s') }} value='34'>ปาวา3</option>
