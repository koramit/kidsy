...
<body>
    ...
    <div style="text-align: center; page-break-after: always;">
        <p>หอผู้ป่วยไตเทียมสง่า นิลวรางกูร อาคารนวมินทรบพิตร 84 พรรษา ชั้น 10 โรงพยาบาลศิริราช โทร 99793 [updated @ {{ $case->updated_at }}]</p>
    </div>
